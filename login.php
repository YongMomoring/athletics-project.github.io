...
require_once("database_config.php");
	if(isset($_POST['login'])){
		...
		$email =  $_POST['email'];
		$password= $_POST['pass'];
		$sql = "SELECT * FROM athletics_user where email ='".$email."' AND password='".$password."'";
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							<h4>New to Athletics?</h4>
							<p>Create an account for free now !</p>
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST" id="contactForm" novalidate="novalidate">
